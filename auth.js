...
function vmApplyReadonly(user) {
    ...
    st.textContent = [
        ...
        'body.vm-readonly input[type="password"],',
        'body.vm-readonly textarea[name],',
        'body.vm-readonly .u-inp { pointer-events: none; opacity: 0.85; }',
...
function vmLoadSupportChat() {
    ...
    css.rel = 'stylesheet';
    css.href = 'support-chat.css?v=16';
    document.head.appendChild(css);
    const s = document.createElement('script');
    s.src = 'support-chat.js?v=12';
    s.defer = true;
